"""add chat and provider tables

Revision ID: ec1e6cd7a1eb
Revises: 62c6f8d9b6b8
...
revision: str = 'ec1e6cd7a1eb'
down_revision: Union[str, Sequence[str], None] = '62c6f8d9b6b8'
...
def upgrade() -> None:
    ...
    op.create_index('ix_conversations_user_id_last_chat_time', 'conversations', ['user_id', 'last_chat_time'], unique=False)
